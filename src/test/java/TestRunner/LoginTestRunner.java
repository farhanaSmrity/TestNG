...
public class LoginTestRunner extends Setup {
    ...
    @Test (priority = 2,enabled = true,groups = "login_smoke")
    ...
    public void doLoginWithValidEmailandWrongPassword() throws InterruptedException, IOException, ParseException {
        LoginPage loginPage = new LoginPage(driver);
        driver.get("http://automationpractice.com/");
        String errorMassage =  loginPage.doLoginWithValidEmailandWrongPassword("salman@test.com","123456");
        Assert.assertTrue(errorMassage.contains("Authentication failed."));
    ...
    public void doLoginWithInvalidEmail() throws InterruptedException, IOException, ParseException {
        LoginPage loginPage = new LoginPage(driver);
        String errorMassage =  loginPage.doLoginWithInvalidEmail("salman","123456");
        Assert.assertTrue(errorMassage.contains("Invalid email address."));
